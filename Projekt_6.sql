...
select 
	a.payroll_year, round(a.avg_payroll), round(((b.avg_payroll-a.avg_payroll)/a.avg_payroll),3)*100 as payroll_chng,
	round(a.avg_price,2)as avg_price, round(((b.avg_price - a.avg_price)/a.avg_price),3)*100 as price_chng,
	CASE
